...
pub fn linear_ode_solve(
    ...
    *out_dfdt_arr = k1.clone();
    ...
    while t < tend {
        ...
        point3 =
            cur_point.clone() + tstep * ((ODE45_A31 * (k1.clone())) + (ODE45_A32 * (k2.clone())));
        ...
        if normctrl {
            nerr =
                arrayfire::norm::<f64>(&subtract, arrayfire::NormType::VECTOR_2, 0.0, 0.0) as f64;
