...
pub fn get_outside_idx_cube(pos: &arrayfire::Array<f32>, cube_size: f32) -> arrayfire::Array<u32> {
...
pub fn get_inside_idx_cube(pos: &arrayfire::Array<f32>, cube_size: f32) -> arrayfire::Array<u32> {
    let neg_cube_size = -cube_size;
