...
fn main() {
    ...
    let density_list = vec![
        16.0e-5, 32.0e-5, 64.0e-5, 128.0e-5, 256.0e-5, 512.0e-5, 1024.0e-5, 2048.0e-5,
    ];

    //Save Collision Runtime
    raybnn::export::dataloader_f32::write_vec_cpu_to_csv("./density_list.csv", &density_list);
    ...
    for ii in 0..density_list.len() {
        ...
        arch_search.neural_network.netdata.con_rad =
            80.0 * arch_search.neural_network.netdata.neuron_rad;
