...
fn main() {
    let RT3_RAD_vec: Vec<f32> = vec![
        10.0, 20.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0, 130.0, 150.0,
        200.0,
    ];
    ...
    for run_num in 0..11 {
        ...
        for RT3_RAD in RT3_RAD_vec.clone() {
            ...
            let neuron_size_vec: Vec<u64> =
                vec![40, 50, 70, 160, 170, 180, 190, 200, 230, 270, 300];
                ...
                */
                ...
                if (prev_target_neuron_size != neuron_size_vec[ii]) {
                    ...
                    let add_neuron_options: add_neuron_option_type = add_neuron_option_type {
                        ...
                        hidden_neuron_con_rad: RT3_RAD
                            * arch_search.neural_network.netdata.neuron_rad,
