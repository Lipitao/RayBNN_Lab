...
fn main() {
    ...
    let active_size: u64 = 40;
    let max_neuron_size: u64 = 100;
    let batch_size: u64 = 50;
    let traj_size: u64 = 1;
    let proc_num: u64 = 4;
    let dir_path: String = "/home/jdoe/ray_project/temp".to_string();
    ...
    let TOTAL_RSSI_TRAINX = raybnn::export::dataloader_f32::file_to_hash_cpu(
        "./test_data/diabetes_train_X.dat",
        max_input_size,
        batch_size * traj_size,
    );
    ...
    let RSSI_TRAINY = raybnn::export::dataloader_f32::file_to_hash_cpu(
        "./test_data/diabetes_train_y.dat",
        output_size,
        batch_size * traj_size,
    );
    ...
    */
    ...
    for count in 1..=200 {
        ...
        //let train_stop_options_clone = train_stop_options.clone();
    ...
    for value in Yhat_out.values() {
        output_vec.extend(value);
    }

    save_vec_to_file(&output_vec, "output.txt");
}
