...
fn main() {
    ...
    let fold_index: Vec<u64> = vec![0, 1, 2, 3, 4, 6, 7, 8, 9, 10];
    let epoch_array: Vec<u64> = vec![100, 150, 200, 250, 300];
    ...
    for epoch in epoch_array {
        ...
        */
        ...
        let file_path = format!("./output_csv/cifar10_flat/G_epoch{}.csv", epoch);
